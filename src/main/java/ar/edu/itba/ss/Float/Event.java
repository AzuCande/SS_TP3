...
public class Event implements Comparable<Event> {
    ...
    public Event(float time, EventType eventType, Ball a, Ball b) {
        this.time = time;
        this.a = a;
        this.b = b;
        this.eventType = eventType;

        if (a != null) this.collisionCountA = a.getCollisionCount();
        else collisionCountA = -1;

        if (b != null) this.collisionCountB = b.getCollisionCount();
        else collisionCountB = -1;
    }
    ...
    public int compareTo(Event x) {
        return Float.compare(this.time, x.getTime());
    }
    ...
    public boolean equals(Object o) {
        ...
        Event event = (Event) o;
        return Float.compare(event.time, time) == 0 && collisionCountA == event.collisionCountA && collisionCountB == event.collisionCountB && Objects.equals(a, event.a) && Objects.equals(b, event.b);
    }
